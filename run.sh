...
mpirun -np 8 -hostfile hostfile --prefix $CONDA_PREFIX -x NEST_MODULE_PATH=$NEST_MODULE_PATH -x NEST_DATA_DIR=$NEST_DATA_DIR -bind-to none -map-by slot --mca pml ob1 --mca btl tcp,self --mca btl_tcp_if_include enp6s0f0 python main.py
